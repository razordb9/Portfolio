<main class="agb">
    ...
    <div class="agb-container">
        ...
        <br>
        Wir gehen davon aus, dass Sie bei Zugriff auf die Website die Allgemeinen Geschäftsbedingungen in vollem Umfang akzeptieren. Bitte fahren Sie mit der Nutzung von hzs.at nicht fort, sofern Sie nicht mit allen auf dieser Seite aufgeführten Bedingungen einverstanden sind. <br>  
        <br>
        Cookies:<br>
        Die Website verwendet Cookies, um Ihr Online-Erlebnis zu personalisieren. Durch weiteren Zugriff auf hzs.at stimmen Sie der Verwendung von Cookies zu.
        <br><br>
        ...
        <br><br>
        Lizenz:<br>
        Sofern nicht anderweitig angegeben haben Hudson-Zaußnig Solutions und/oder seine Lizenzgeber die geistigen Eigentumsrechte für alle Materialien auf hzs.at. Alle Rechte am geistigen Eigentum sind vorbehalten. Sie können Seiten von hzs.at für Ihren eigenen persönlichen Gebrauch ansehen und/oder ausdrucken, vorbehaltlich der in diesen Allgemeinen Geschäftsbedingungen festgelegten Einschränkungen.
        <br><br>
        Folgendes ist untersagt:
        <br>
        <ul>
            <li>Veröffentlichung des Materials von hzs.at</li>
            <li>Verkauf, Vermietung oder Unterlizenzierung des Materials von hzs.at</li>
            <li>Reproduktion, Vervielfältigung oder Kopie des Materials von hzs.at</li>
            <li>Weiterverbreitung der Inhalte von hzs.at</li>
        </ul>
        <br>
        ...
        <br><br>
        Hudson-Zaußnig Solutions behält sich das Recht vor, alle Kommentare zu überprüfen und eventuell zu entfernen, wenn jene als unangemessen, anstößig oder als Verstoß gegen die Allgemeinen Geschäftsbedingungen betrachtet werden können.
        <br><br>
        ...
        <br>
        Sie gewähren Hudson-Zaußnig Solutions hiermit eine nicht-exklusive Lizenz zur Nutzung, Reproduktion, Bearbeitung und Autorisierung anderer zur Nutzung, Reproduktion und Bearbeitung Ihrer Kommentare in allen Formen, Formaten oder Medien.
        <br><br>
        Verlinken unserer Inhalte:<br>
        ...
        <div class="agb-list">
            <ul>
                ...
                <li>Wirtschaftsprüfungs-, Rechts- und Beratungsunternehmen und</li>
        ...
        Wir werden Linkanfragen von solchen Organisationen genehmigen, sofern: (a) der Link keine negativen Auswirkungen für uns oder unsere akkreditierten Unternehmen hat; (b) es in der Vergangenheit zu keinem Zeitpunkt zu Unstimmigkeiten mit der Organisation kam; (c) die Vorteile der Sichtbarkeit des Links trotz fehlender Nennung von Hudson-Zaußnig Solutions überwiegen und (d) der Link im Kontext allgemeiner Ressourceninformationen steht.
        <br><br>    
        ...
        Ohne Lizenzvereinbarung zur Markennutzung dürfen weder das Logo von Hudson-Zaußnig Solutions noch andere Grafikelemente zur Verlinkung verwendet werden.
        <br><br>
        ...
        <br><br>
        Entfernung von Links von unserer Website:<br>
